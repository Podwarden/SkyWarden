...
/* LOCAL EDIT: we use Z80_CATCH_HALT so HALT stops Z80Emulate and returns,
 * letting the host detect the player's wait-for-INT loop. Upstream z80emu.c
 * references undefined Z80_STATUS_FLAG_HALT etc. — alias them here so the
 * code compiles without touching z80emu.c. */
#define Z80_CATCH_HALT
