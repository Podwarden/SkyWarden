...
emulate_next_instruction:
				...
				if ((Y(opcode) & 0x03) <= 0x01)
                        ...
                        case IN_A_N: {
                                ...
                                READ_N(n);
                                /* LOCAL EDIT: present 16-bit port (A in upper byte)
                                 * so ZX-Spectrum-style A15/A14 decoding works. */
                                n |= (int)A << 8;
                                Z80_INPUT_BYTE(n, A);
                        ...
                        case IN_R_C: {
                                ...
                                int     x;                                           
                                Z80_INPUT_BYTE(BC, x);  /* LOCAL EDIT: full 16-bit port */
                        ...
                        case OUT_C_R: {
                                ...
                                x = Y(opcode) != INDIRECT_HL
                                        ? R(Y(opcode))
                                        : 0;
                                Z80_OUTPUT_BYTE(BC, x);  /* LOCAL EDIT: full 16-bit port */
